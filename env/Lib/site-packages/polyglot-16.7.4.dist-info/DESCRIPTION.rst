...
.. code:: python
    ...
    text = Text(u"O primeiro uso de desobedi锚ncia civil em massa ocorreu em setembro de 1906.")
...
.. code:: python
    ...
    text = Text(u"In Gro脽britannien war Gandhi mit dem westlichen Lebensstil vertraut geworden")
    print(text.entities)
